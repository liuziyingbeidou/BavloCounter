...
if(opts.pagination){
$.extend(_6c5,{dgpage:opts.pageNumber||1,rows:opts.pageSize});
}
if(opts.sortName){
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:true}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupView:_7b5,groupField:"group",groupFormatter:function(_7f2,rows){
return _7f2;
}});
})(jQuery);
(function($){
...
_9c0(this,q);
}},currentText:"Today",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_9d5){
...
{text : function(_9d10) {
return $(_9d10).datebox("options").cleanText;
},handler : function(_9d11) {
$(_9d11).combo("setValue", "").combo("setText", ""); // 设置空值
$(_9d11).combo("hidePanel"); // 点击清空按钮之后关闭日期选择面板
}},
{text:function(_9d7){
