  	...
  	function returnBrowserTest(){
				...
				var theLink = $(element).attr('href');
			  	...
			  	$(element).bind('click',function(e){
				  	...
				  	html += "<p style='text-align:center;'><a href='" + theLink + "'><img src='/counter/resources/Downloadr/downloadr/download.png' alt='Right click and save as to download' id='download_file'/></a></p>";
