...
import com.bavlo.counter.exception.JException;
import com.bavlo.counter.exception.TxException;
import com.bavlo.counter.system.config.BtcAppConfig;
import com.bavlo.counter.utils.CheckRule;
import com.bavlo.counter.utils.DaoHelper;
import com.bavlo.counter.utils.DateUtils;
...
import com.bavlo.counter.utils.SQLUtils;
import com.bavlo.counter.utils.TypeExchangeUtils;
import com.bavlo.counter.utils.UniqueRule;
...
public class HibernateDAO implements IHibernateDAO {
	...
	/**
	 * liuzy 主子表保存 事物 ：特殊逻辑-- 把子表的数据删除，然后全部按照插入处理；
	 * 
	 * @param zbjson
	 *            主表的json
	 * @param deleted
	...
	private Session getSession() {
		...
		if (BtcAppConfig.isSimpleServer) {
